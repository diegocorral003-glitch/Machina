  ...
  return (
    <div className="min-h-screen bg-dark-950 flex flex-col items-center justify-center relative overflow-hidden py-12">
      ...
      <motion.div 
        ...
        className="w-full max-w-md bg-dark-900 border border-dark-800 p-8 rounded-sm shadow-2xl relative z-10 my-8"
      >
        ...
        <div className="mt-8 pt-6 border-t border-dark-800 text-center">
          <p className="text-gray-500 text-sm">
            ¿Ya tienes una cuenta? <Link to="/login" className="text-white font-bold hover:text-primary transition-colors">Iniciar Sesión</Link>
          </p>
        </div>
      </motion.div>
