...
export default function Login() {
  return (
    <div className="min-h-screen bg-dark-950 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-dark-900 border border-dark-800 p-8 rounded-sm shadow-2xl relative z-10">
        ...
        <div className="mt-8 pt-6 border-t border-dark-800 text-center">
          <p className="text-gray-500 text-sm">
            ¿Aún no eres cliente? <Link href="/register" className="text-white font-bold hover:text-primary transition-colors">Crear Cuenta</Link>
          </p>
        </div>
      </div>
